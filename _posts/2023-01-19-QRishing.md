...
> Tened en cuenta que no se realizará todo lo "profesional" posible, no se externalizarán los servicios y solo serán accesibles desde la red local.
{: .prompt-info}

<h1> ESCENARIO 1: CONSEGUIR CREDENCIALES </h1>

Lo primero de todo, vamos a abrir nuestra máquina de atacante, en mi caso utilizaré Kali Linux.

<h1> ESCENARIO 2: DAR INFORMACIÓN ERRÓNEA</h1>
