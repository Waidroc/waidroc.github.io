...
El siguiente paso es descargar el software [`Rufus`](https://github.com/pbatard/rufus/releases/download/v4.3/rufus-4.3.exe) para poder bootear nuestra memoria USB y poder iniciar Tails desde ella, indicándole la imagen descargada anteriormente.
