...
Otra funcionalidad muy vistosa es que T-pot ofrece una nube de frecuencia con todos los usuarios y contraseñas que han probado los atacantes (dándonos así indicios de que usuarios y contraseñas no debemos usar en nuestros equipos, ya que los ciberatacantes podrían penetrar nuestros sistemas de manera más fácil).

![PASS](/assets/img/2023-04-21/pass.png)

Aparte, T-Pot también ofrece dashboards mas específicos para cada HoneyPot, concretando con métricas mas detalladas que se escapan del alcance de este articulo, pero que sin duda os animo a investigar y trastear.
